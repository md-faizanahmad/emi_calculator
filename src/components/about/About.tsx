      ...
      <div>
        ...
        >
          ...
          <div className="text-black rounded-lg p-6  ">
            ...
            >
              EMI Mitra is more than just an EMI calculator—it’s a comprehensive
              toolkit designed to simplify financial planning and daily tasks
              for students, professionals, and anyone navigating life’s
              challenges. Whether you’re calculating loan EMIs for a home, car,
              or personal needs, creating a professional resume, or converting
              images to PDFs, EMI Mitra offers free, user-friendly tools to make
              your life easier. Our mission is to empower you with accurate,
              accessible, and privacy-focused solutions, ensuring you can focus
            ...
            <p className="text-gray-600 dark:text-black-300 mb-4">
              ...
              daily life success. From financial planning to productivity, we’ve
              got you covered with features like:
            </p>
            <ul className="list-disc list-inside text-gray-600 dark:text-black-300 mb-6 space-y-2">
              ...
              <li>
                <strong>Resume Maker</strong>: Create professional resumes with
                customizable templates, perfect for students applying for
                internships or jobs.
              </li>
              <li>
                <strong>Image to PDF Converter</strong>: Convert images to PDFs
                quickly and securely, ideal for submitting assignments or
                documents without storing your files.
              </li>
              <li>
                <strong>Student Calculator</strong>: Perform quick calculations
                for budgeting, percentages, or academic needs, all in one place.
              </li>
              <li>
                <strong>Privacy-First Approach</strong>: We do not save your
                data or PDFs, ensuring your personal information remains secure
                and private.
              </li>
              <li>
            ...
            <p className="text-gray-600 dark:text-black-300 mb-6">
              ...
              does not store your data, calculations, or uploaded files, such as
              PDFs or images. All processing happens client-side, meaning your
              information stays with you. Whether you’re using our resume maker,
              image to PDF converter, or EMI calculator, you can trust that your
              data is safe and never saved on our servers.
            </p>
            <h4 className="text-lg font-semibold text-gray-900 dark:text-black mb-2">
            ...
            <p className="text-gray-600 dark:text-black-300 mb-6">
              ...
              repayments. Preparing for a job interview? Use our resume maker to
              stand out. Submitting assignments? Convert images to PDFs
              effortlessly. Our tools are free, intuitive, and optimized for SEO
              searches like “student calculator,” “resume maker,” and “image to
              PDF converter,” making EMI Mitra your go-to resource for daily
              life.
            </p>
